  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-ash mt-1">Link your WhatsApp Business account to start automating conversations.</p>
      </div>

      <Card className="max-w-xl mx-auto mt-12 border-0 shadow-sm overflow-hidden">
        <div className="h-1.5 bg-gradient-to-r from-apricot-wash via-sky-wash to-apricot-wash" />
        <CardHeader className="text-center pt-10">
          <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-fog mx-auto mb-6">
            <Smartphone className="h-8 w-8 text-ash" />
          </div>
        ...
        <CardContent className="flex justify-center pb-10">
          <div className="w-64 h-64 bg-fog rounded-xl border flex items-center justify-center relative overflow-hidden">
            {status === "CONNECTED" ? (
              ...
              <div className="flex flex-col items-center gap-3">
                <QrCode className="h-12 w-12 text-ash/30" />
        ...
        <CardFooter className="bg-fog/30 border-t py-4 flex justify-between">
          <Button variant="link" className="gap-1 text-xs text-ash">
            <HelpCircle className="h-3 w-3" />
            Having trouble?
          </Button>
          <Button onClick={handleGenerateQR} disabled={loading || status === "CONNECTED"} className="gap-2 rounded-full">
